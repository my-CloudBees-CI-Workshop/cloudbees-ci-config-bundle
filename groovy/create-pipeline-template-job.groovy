...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/my-CloudBees-CI-Workshop/pipeline-template-catalog.git");
      ...
      <instance>
        ...
        <values class="tree-map">
          ...
          <entry>
            ...
            <string>my-CloudBees-CI-Workshop</string>
          </entry>
          <entry>
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>my-CloudBees-CI-Workshop</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/my-CloudBees-CI-Workshop/pipeline-template-catalog.git</repositoryUrl>
              <traits>
